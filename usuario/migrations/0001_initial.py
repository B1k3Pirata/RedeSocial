# Generated by Django 3.2.8 on 2021-11-02 20:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ct1', models.CharField(default='', max_length=105, verbose_name='contato #1')),
                ('ct2', models.CharField(default='', max_length=105, verbose_name='contato #2')),
                ('matric', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='usuario.matricula')),
            ],
            options={
